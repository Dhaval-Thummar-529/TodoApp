...
class ActiveListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
        color: controller.getDateDifference(controller.active[index].startDate!, controller.active[index].endDate!)+1 <= 1 ? Colors.red.withOpacity(0.8) : controller.getDateDifference(controller.active[index].startDate!, controller.active[index].endDate!)+1 <= 2 ? Colors.orangeAccent.withOpacity(0.8) : Colors.green.withOpacity(0.8),
        elevation: 10,
        shape:
